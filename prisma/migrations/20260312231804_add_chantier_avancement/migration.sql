...
INSERT INTO "new_Chantier" ("budget", "code", "createdAt", "date_debut", "date_fin", "description", "directeur", "domaine", "duree_mois", "id", "nom", "pmo", "priorite", "statut", "type_chantier", "updatedAt") SELECT "budget", "code", "createdAt", "date_debut", "date_fin", "description", "directeur", "domaine", "duree_mois", "id", "nom", "pmo", "priorite", "statut", "type_chantier", "updatedAt" FROM "Chantier";
DROP TABLE "Chantier";
