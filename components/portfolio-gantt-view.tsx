    ...
    <div className={fullscreen ? "fixed inset-0 z-[60] overflow-auto bg-background p-5" : "space-y-4"}>
      ...
      <div className="rounded-xl border bg-card p-5 shadow-sm">
        ...
        <div className="space-y-3 border-t pt-4 text-xs">
          ...
          <Button variant="ghost" size="sm" className="h-8" onClick={() => { setFilterDu(''); setFilterAu(''); setIntersectOnly(false); setTimelineScope('period'); setScale('quarter'); }}><ScanLine className="size-4" />Ajuster</Button>
          </div>
        </div>
      </div>
